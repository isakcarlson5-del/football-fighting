...
camera, strong silhouette at 96 px, dark navy vignette, no text, logos,
watermarks, UI frames or split panels.

- `strike`: visible instep contact launching a golden aerial arc over near mobs
  toward a blue far-target reticle.
- `orbit`: three balls circling close to the player on a cyan ground trail and
  shoving nearby threats.
- `whistle`: a silver whistle emitting concentric pitch-hugging shockwaves.
- `dash`: a cleated boot sweeping through a narrow lane with a green turf trail.
